...
-- Tareas FINALIZADAS
('Álgebra lineal', 'Sistemas de ecuaciones 3x3, método de eliminación gaussiana.', 'Matemáticas', '2025-07-20', 'Finalizada', 5, 1, 'Excelente progreso. Te expliqué el método paso a paso y ahora dominas la eliminación gaussiana. ¡Sigue así!'),
('Ensayo argumentativo', 'Estructura y técnicas para escribir ensayos persuasivos.', 'Literatura', '2025-07-21', 'Finalizada', 6, 4, 'Tu ensayo mejoró considerablemente. Recuerda usar conectores y evidencia sólida.'),
('JavaScript básico', 'Fundamentos de programación web con JavaScript.', 'Programación', '2025-07-22', 'Finalizada', 1, 2, 'Tu proyecto de calculadora quedó excelente. Buen manejo de eventos y funciones.'),
('Conversación en inglés', 'Práctica de speaking y pronunciation en inglés.', 'Inglés', '2025-07-23', 'Finalizada', 2, 3, 'Tu pronunciación mejoró mucho. Practica 15 min diarios viendo series subtituladas.'),
('Revolución Industrial', 'Causas y consecuencias de la Revolución Industrial europea.', 'Historia', '2025-07-19', 'Finalizada', 3, 5, 'Buen análisis de consecuencias sociales. Tu línea de tiempo quedó excelente.');
